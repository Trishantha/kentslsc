...
import { MembershipTypePricingForm } from './MembershipTypePricingForm';
...
export default async function MembershipTypePricingPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl">
      <MembershipTypePricingForm membershipType={type} />
    </div>
  );
}
