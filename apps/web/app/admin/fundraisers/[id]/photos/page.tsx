...
import { FundraiserPhotosManager } from './FundraiserPhotosManager';
import type { AdminFundraiser } from '../../types';

export default function FundraiserPhotosPage() {
  ...
  return (
    <div className="max-w-3xl">
      <FundraiserPhotosManager fundraiser={fundraiser} fundraiserId={id} />
    </div>
  );
}
