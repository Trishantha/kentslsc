        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center text-slate-100">
          ...
          >
            {!user && (
              <Link
                href="/auth/register"
                className="btn-primary flex-1 max-w-[10rem] px-4 py-2.5 text-center text-sm"
              >
                Become a Member
              </Link>
            )}
            <Link
              href="/events"
              className="btn-secondary flex-1 max-w-[10rem] px-4 py-2.5 text-center text-sm"
            >
              Explore Events
            </Link>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: Users, title: 'Membership', desc: 'Join as a member and unlock exclusive benefits.', href: '/auth/register' }
            ].map((feature) => (
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-2xl font-bold">Recommended Events</h3>
              </div>
              ...
              <div className="mt-6 space-y-4">
                {eventsLoading ? (
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">No upcoming events right now. Check back soon!</p>
                ) : (
            ...
            >
              ...
              {fundraisersLoading ? (
                ...
                <p className="mt-6 text-sm text-slate-600 dark:text-slate-400">No active fundraisers at the moment.</p>
              ) : (
                <div className="mt-6">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-700 dark:text-slate-400">Support Sri Lankan businesses in Kent.</p>
            </div>
          ...
          {businessesLoading ? (
            ...
            <p className="text-slate-600 dark:text-slate-400">No promoted businesses right now.</p>
          ) : (
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-700 dark:text-slate-400">Stories, updates, and community voices.</p>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-700 dark:text-slate-400">Join the latest community conversations.</p>
            </div>
          ...
          {topicsLoading ? (
            ...
            <p className="text-slate-600 dark:text-slate-400">No forum topics yet. Be the first to start a conversation!</p>
          ) : (
